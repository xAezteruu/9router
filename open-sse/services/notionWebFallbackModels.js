 ...
 * Ported from OmniRoute open-sse/services/notionWebFallbackModels.ts.
 * Catalog ids use real web-picker labels (e.g. `fable-5`, `gpt-5.6-sol`);
 * `notionCodename` is the internal food codename `runInferenceTranscript`
 * accepts on the wire.
 */
export const NOTION_WEB_FALLBACK_MODELS = [
