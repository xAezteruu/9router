 ...
 * Ported from OmniRoute open-sse/services/hyperagentModels.ts.
 *
...
export const HYPERAGENT_FALLBACK_MODELS = [
  {
    id: "fable-latest",
    name: "Fable 5",
    subagent: "fable",
...
export function stripHyperAgentModelPrefix(model) {
  let m = (model || "").trim();
...
export function resolveHyperAgentModel(model) {
...
export function clientFacingHyperAgentModelId(model) {
 ...
 */
export function wireHyperAgentModelId(model) {
 ...
 */
export function wireHyperAgentSubagentModelId(model) {
  const resolved = resolveHyperAgentModel(model);
...
export function wireHyperAgentRuntimeId(model) {
  const resolved = resolveHyperAgentModel(model);
